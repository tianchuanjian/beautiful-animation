...
import { formatAmountDisplay, sanitizeAmountInput, stripThousandSeparators, toDisplayValue } from './amount';
...
function handleBlur(event: FocusEvent) {
  ...
  if (props.mode === 'amount') {
    displayValue.value = formatAmountDisplay(
      sanitizeAmountInput(stripThousandSeparators(displayValue.value), props.decimalPlaces),
      props.useThousandSeparator
    );
  }
